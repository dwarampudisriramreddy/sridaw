...
def main():
    ...
    print("1. If Java is missing: sudo apt install openjdk-17-jdk")
    print("2. If you see PPA errors: Remove openjdk-r/ppa and use the official repository.")
    print("3. If build fails: rm -rf .buildozer && buildozer android debug")
    print("4. On newer Ubuntu (24.04+): Use --break-system-packages with pip.")
    print("5. For first build: Expect 30-60 minutes download time")
